...
import com.gnirt69.slidingmenuexample.Database.MyDBHelper;
...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listSliding.add(new ItemSlideMenu(R.drawable.ic_action_settings, "電玩區"));
        listSliding.add(new ItemSlideMenu(R.drawable.ic_action_about, "政治區"));
        listSliding.add(new ItemSlideMenu(R.mipmap.ic_launcher, "八卦區"));
